#!/usr/bin/env ruby
# redis_monitor_web_sse.rb - Web-based Redis pub/sub message monitor
...
class RedisMessageMonitor < Sinatra::Base
          ...
          <div class="container">
              ...
              <div class="main-content">
                  <div class="header">
                      ...
                      <p style="color: #888; font-size: 12px; margin-top: 5px;">Real-time monitoring of Messages::* Redis pub/sub channels (SSE Mode)</p>
                  </div>
          ...
          <script>
              ...
              function startSSE() {
                  ...
                  eventSource.onopen = function() {
                      updateStatus('connected', 'Connected to Redis (SSE)');
                  };
  ...
  def self.extract_message_type(parsed_message)
    # Try to extract message type from various places (including _sm_header structure)

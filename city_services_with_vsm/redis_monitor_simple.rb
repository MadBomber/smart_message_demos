    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="header">
                ...
                <p style="color: #888; font-size: 12px; margin-top: 5px;">Real-time monitoring of SmartMessage Redis pub/sub channels (Polling Mode)</p>
            </div>
  ...
  get '/api/messages' do
    ...
    settings.buffer_lock.synchronize do
      settings.message_buffer.each do |msg|
        next if msg[:timestamp] <= since

        if should_display_message?(msg[:message_type], msg[:from], msg[:to])
